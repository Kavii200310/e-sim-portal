...
const NotEligibleStatusCard = ({ title, message, buttonText, onButtonClick, secondaryMessage }) => {
    return (
        <Card className={cn(
                ...
                <div className="pt-2 w-full max-w-xs">
                    <Button
                        ...
                        className={cn(
                            ...
                            "bg-slate-200 hover:bg-slate-300 text-slate-900 shadow-slate-200"
                        )}
                    >
                        {buttonText}
                    </Button>
...
export default NotEligibleStatusCard;
